...
public class JsonOrBean {
	...
	/**
	 * @category 简单|复杂类型：将java对象转换成json字符串<br>
	...
	/**
	 * @category 从json对象集合表达式中得到一个java对象列表
	 * 
	 * @param jsonString
	 * @param pojoClass
	 * @return
	...
	/**
	 * @category 从java对象集合表达式中得到一个json列表
	 * 
	 * @param list
	 * @return
	 */
