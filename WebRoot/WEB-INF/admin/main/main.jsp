...
<html>
	...
	<body id="adminMain" class="easyui-layout" data-options="fit:true">
	    <div data-options="region:'north',split:false,href:'<%=basePath%>htmain/topjsp'" style="height:100px;"></div>   
	    <div data-options="region:'south',split:false,href:'<%=basePath%>htmain/buttonjsp'" style="height:100px;"></div>   
	    <div data-options="region:'east',href:'<%=basePath%>htmain/rightjsp',iconCls:'icon-reload',title:'East',split:false" style="width:200px;"></div>   
